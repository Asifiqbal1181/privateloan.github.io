...
<section class="home">
   ...
   <div class="content">
      ...
      <p>Search for private lending companies, view their detailed profiles, and contact them directly..</p>
...
<section class="checkout">
   ...
   <form action="contact.php" method="post">
      <h3>Please Select a Loan Type</h3>
      <div class="flex">
         <div class="inputBox">
            ...
            <select name="loan" required>
               ...
               <option value="Residential Bridge">Residential Bridge</option>
            </select>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="loanamount" placeholder="Loan Amount" required >
         </div>
